                ...
                <div className="flex flex-col">
                    {steps.map((step, index) => (
                        <motion.div
                            ...
                            className="group"
                        >
                            <div className="border-t-2 border-dark/90 md:border-dark/60 py-6 md:py-10 flex flex-row justify-between items-start md:items-center gap-4">
                    ...
                    <div className="border-t-2 border-dark/90 md:border-dark/60 w-full"></div>
                </div>
            </div>
        </section>
    );
