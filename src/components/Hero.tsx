...
const Hero = () => {
    return (
        <section id="home" className="pt-32 md:pt-40 pb-12 md:pb-20 px-6 max-w-[1440px] mx-auto grid md:grid-cols-2 gap-16 md:gap-32 items-center">
            <motion.div
            ...
            <motion.div
                ...
                className="relative mt-8 md:mt-0 max-w-[540px] mx-auto w-full"
            >
                <div className="relative z-10 rounded-[32px] md:rounded-[48px] overflow-hidden">
                    <img src="/hero_main.png" alt="Marketing Illustration" className="w-full h-auto" />
                </div>
